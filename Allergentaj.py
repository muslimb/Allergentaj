...
if b == 'E':
    ...
    for seq_record1 in records:
        ...
        if a in y:
            ...
            muslim.append(seq_record1.description)
        elif a not in seq_record1:
            normatov.append(seq_record1.description)
    print('The amino acid sequence you indicated is contained\n'
          'in', len(muslim), 'human allergen proteins.')
    print('---------------------------------------------------------')
    print('The amino acid sequence you specified is not contained\n'
          'in', len(normatov), 'human allergen proteins')
    print('---------------------------------------------------------')
    ...
    print('Указанная вами аминокислотная последовательность\n'
          'содержится в', len(muslim), 'белках аллергенах\n'
          'человека.\n')
    print('------------------------------------------------------')
    print('Указанная вами аминокислотная последовательность\n'
          'не содержится в', len(normatov), 'белках аллергенах\n'
          'человека.\n')
    print('------------------------------------------------------')
